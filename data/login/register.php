...
if ($_POST['Submit'] == 'Register')
{
   ...
   {
    die ("Hibás e-mail cím!");
    }
   if (strcmp($_POST['pass1'],$_POST['pass2']) || empty($_POST['pass1']) )
	{ 
	//die ("Password does not match");
	die("HIBA: A két jelszó nem egyezik meg.");

	}
	if (strcmp(md5($_POST['user_code']),$_SESSION['ckey']))
	{ 
			 die("Hibás megerősítő kód.");
  		} 
	...
	$message = 
"Köszönjük, hogy regisztráltál $server. \n\n
E-mail: $_POST[email] \n
Jelszó: $_POST[pass2] \n
Aktivációs kód: $activ_code \n
____________________________________________
*** AKTIVÁLÓ LINK ***** \n
 Link: http://$server/activate.php?usr=$_POST[email]&code=$activ_code \n\n
...
";
	...
	unset($_SESSION['ckey']);
	echo("Regisztráció befejezve, az aktiváló linket elküldtük az e-mail címedre...");	
...
<table width="65%" border="0" cellpadding="0" cellspacing="0">
  <tr> 
    <td bgcolor="d5e8f9" class="mnuheader"><strong><font size="5">Regisztráció</font></strong></td>
  </tr>
  <tr> 
